 ...
 */
export function serversConfigure(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostServersByIdRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ConfigRequest, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ConfigResponse$inboundSchema),
