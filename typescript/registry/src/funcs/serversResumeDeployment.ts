...
> {
  const parsed = safeParse(
    ...
    (value) =>
      operations
        .PostServersByQualifiedNameDeploymentsByIdResumeRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/servers/{qualifiedName}/deployments/{id}/resume")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "postServersByQualifiedNameDeploymentsByIdResume",
    oAuth2Scopes: null,
