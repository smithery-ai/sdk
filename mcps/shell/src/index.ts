...
>>>>>>> d7f68e5 (update purpose param for shell call)
})
...
export function createServer(options: ShellServerOptions = {}) {
	...
	const approvalHandler =
		options.approvalHandler || (() => Promise.resolve(true))
			...
			tools: [
				{
					...
					description: `Execute a shell command safely. Only allowed commands: ${[...ALLOWED_COMMANDS].join(", ")}. Provide a clear purpose explaining what the command will do. Command will require human approval before execution.`,
