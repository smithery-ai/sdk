...
[![NPM version](<https://img.shields.io/npm/v/smithery.svg?label=npm%20(stable)>)](https://npmjs.org/package/smithery) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/smithery)
...
```sh
npm install git+ssh://git@github.com:smithery-ai/sdk.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install smithery`
...
1. Via the `PETSTORE_LOG` environment variable
...
const client = new Petstore({
  logger: logger.child({ name: 'Petstore' }),
...
```ts
import Petstore from 'npm:smithery';
...
We are keen for your feedback; please open an [issue](https://www.github.com/smithery-ai/sdk/issues) with questions, bugs, or suggestions.
