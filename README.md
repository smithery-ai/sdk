...
[![NPM version](https://img.shields.io/npm/v/smithery.svg)](https://npmjs.org/package/smithery) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/smithery)
...
> [!NOTE]
> Once this package is [published to npm](https://app.stainlessapi.com/docs/guides/publish), this will become: `npm install smithery`
...
To do the inverse, add `import "smithery/shims/node"` (which does import polyfills).
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/stainless-sdks/smithery-node/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/smithery-node/issues) with questions, bugs, or suggestions.
